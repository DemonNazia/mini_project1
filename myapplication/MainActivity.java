...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
                ...
                firebaseAuth.signInWithEmailAndPassword(s1,s2).addOnCompleteListener(new OnCompleteListener<AuthResult>()
                {
                    ...
                    public void onComplete(@NonNull @NotNull Task<AuthResult> task)
                    {
                        if(task.isSuccessful())
                        {
                            ...
                            Intent j2 = new Intent(MainActivity.this, Home.class);
                            startActivity(j2);
                            finish();
                        }
                        else
                        {
                            ...
                            Intent j2 = new Intent(MainActivity.this, SignUp.class);
                            startActivity(j2);
                            finish();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent j1 = new Intent(MainActivity.this, SignUp.class);
                startActivity(j1);
                finish();
